		   ...
		   <!--start-image-slider---->
		    ...
		    <div class="content">
				...
				<div class="grid_1_of_3 images_1_of_3">
					  <a href="single.html"><img src="Frontend/img/logo-ford.jpg" style="background-color: white"></a>
					  <h3>Thương hiệu nổi bật </h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 ">
					   <a href="single.html"><img src="Frontend/img/logo-mercedes.png" style="background-color: white"></a>
					  <h3 >Thương hiệu nổi bật</h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 ">
					   <a href="single.html"><img src="Frontend/img/logo-toyota.png" style="background-color: white"></a>
					  <h3>Thương hiệu nổi bật</h3>
				</div>
			</div>
		    	</div>
